  ...
  plugins.blink-cmp.settings.sources = {
    default.__raw = ''
      function(ctx)
        ...
        ${lib.optionalString (config.plugins.blink-cmp-dictionary.enable || config.plugins.blink-cmp-words.enable) "table.insert(common_sources, 'dictionary')"}
        ...
        if success and node and vim.tbl_contains({ 'comment', 'line_comment', 'block_comment' }, node:type()) then
          ...
          ${lib.optionalString (config.plugins.blink-cmp-dictionary.enable || config.plugins.blink-cmp-words.enable) "table.insert(comment_sources, 'dictionary')"}
        ...
        elseif vim.bo.filetype == 'gitcommit' then
          ...
          ${lib.optionalString (config.plugins.blink-cmp-dictionary.enable || config.plugins.blink-cmp-words.enable) "table.insert(git_sources, 'dictionary')"}
    ...
    providers = {
      ...
      dictionary = lib.mkIf (config.plugins.blink-cmp-dictionary.enable || config.plugins.blink-cmp-words.enable) {
        name = "Dict";
        module = if config.plugins.blink-cmp-words.enable then "blink-cmp-words.dictionary" else "blink-cmp-dictionary";
